                        ...
                        <div class="headerCartWrap">
                            ...
                            <div class="headerCartWrapInAll">
                                <div class="d-flex headerCartWrapIn">
                                    <a href="#" class="d-flex ">
                                        <img src="https://github.com/kellolo/static/tree/master/img/JS1_shop/myAccount1.jpg" alt="">
                                        <div>
                                            <div>Rebox Zane</div>
                                ...
                                <div class="d-flex">
                                    <a href="#" class="d-flex headerCartWrapIn">
                                        <img src="https://github.com/kellolo/static/tree/master/img/JS1_shop/myAccount2.jpg" alt="">
                                        <div>
                                            <div>Rebox Zane</div>
                                            <span><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></span>
                                            <div class="headerCartWrapPrice">1 <span>x</span> $250</div>
        ...
        <nav class="nav container d-none d-md-flex justify-content-center mt-3"> 
                ...
                <div class="dropNav">
                    ...
                    <div class="dropNavIn">
                        ...
                        <a href="">
                            <div>Super sale!</div>
                            <img src="https://github.com/kellolo/static/tree/master/img/JS1_shop/navDrop.jpg" alt="nav img">
                        </a>
                    </div>
                </div>
            </div>
