  ...
  <div>
    <header class="container px-0 my-4">
      <div class="row col-12 d-flex px-0 mx-0">
        ...
        <div
          class="d-flex align-items-center col-12 pt-3 col-xl-5 pl-xl-4 px-xl-0 col-lg-5 pl-lg-5 pr-lg-0 px-lg-0 pt-lg-0 col-md-7 px-md-0 pt-sm-3"
        >
          <div class="dropdown">
            <button
      ...
      <div class="row mx-0 d-md-none pt-3 justify-content-between">
        <div class="burgermenu justify-content-between align-items-center col-2 pt-1 col-sm-6">
          <div class="dropdown">
            <button
        ...
        <div
          class="headerAccountAndCart d-flex align-items-center justify-content-end col-2 pt-1 col-sm-6"
        >
          <div class="headerCart pr-4">
            <a href="#">
              <img src="img/cart.png" alt="headerCart" />
            </a>
    ...
    <div class="newArrivalsBg pb-5 pt-5">
      <div
        class="px-md-0 container d-flex flex-column flex-sm-row justify-content-between align-items-center"
      >
    ...
    <main>
      ...
      <div class="container">
            ...
            <div class="feturedItem">
              <div class="feturedImgWrap">
                <div class="feturedBuy">
                  <button name="add" @click="addBasketItem(item)">
                    <div>
        ...
        <div class="container mt-5">
          <div class="row">
            <div
              class="offerWomenLeft px-0 d-flex justify-content-center col-12 col-lg-8 justify-content-lg-start"
            >
            ...
            <div class="offerWomenRight d-flex flex-column px-0 col-12 col-lg-4">
              <div class="d-flex flex-column justify-content-center align-items-center flex-lg-row">
                ...
                <div class="offerWomenDetail">
                  ...
                  <div class="offerWomenDetailBottom">
        ...
        <div class="row pb-5">
          <div class="subscribeReview d-flex col-lg-6 px-0 mt-5 mb-5 pr-0 pr-lg-5">
            ...
            <div class="col-10 pl-5 pl-md-2 pl-lg-5">
              ...
              <div class="reviewsTextName mt-3">Bin Burhan</div>
              <div class="reviewsTextFrom">Dhaka, Bd</div>
              <div class="reviewsTextSwitch mt-5 px-0 col-5 col-xl-4 col-lg-5 col-md-3 col-sm-4">
                <div></div>
                <div></div>
                <div></div>
              </div>
          ...
          <div
            class="subscribeEmail d-flex justify-content-center flex-column align-items-center col-lg-6 border-left"
          >
            <div class="subscribeEmailHead">Subscribe</div>
            <div class="subscribeEmailText pb-4">FOR OUR NEWLETTER AND PROMOTION</div>
            <form class="subscribeForm input-group mb-3 pl-1 pl-sm-4">
              <input
                type="email"
                class="form-control pt-4 pb-4 ml-xl-5 col-lg-7 offset-lg-0 ml-lg-4 col-md-6 offset-md-2 col-sm-9 offset-sm-0"
    ...
    <footer class="container px-0">
      <div class="row col-12 px-0 my-5 no-gutters">
        ...
        <div
          class="bottomNav d-none justify-content-between flex-wrap col-lg-6 pl-lg-4 pt-3 justify-content-md-between pl-sm-0 d-sm-flex"
        >
    ...
    <div class="BgCopyrights">
      <div class="container">
        <div
          class="copyrights d-flex py-4 justify-content-around flex-column align-items-center flex-sm-row justify-content-sm-between"
        >
