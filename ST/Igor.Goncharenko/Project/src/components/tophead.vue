<template>
  <header class="container px-0 my-4">
    <div class="row col-12 d-flex px-0 mx-0">
      ...
      >
        <a href="#" class="pr-2">
          <img src="https://github.com/igogggg/js2cart2/raw/master/logo.png" alt="logo" />
        </a>
    ...
    <div class="row mx-0 d-md-none pt-3 justify-content-between">
      ...
      >
        <div class="headerCart pr-4">
          <a href="#">
            <img src="../assets/imgs/cart.png" alt="headerCart" />
          </a>
          <div class="headerCartWrap">
            ...
            <div class="headerCartWrapInAll">
              <div class="d-flex headerCartWrapIn">
                <a href="#" class="d-flex">
                  <img
                    src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/myAccount1.jpg"
                    alt
                  />
                  <div>
                    <div>Rebox Zane</div>
              ...
              <div class="d-flex">
                <a href="#" class="d-flex headerCartWrapIn">
                  <img
                    src="https://raw.githubusercontent.com/kellolo/static/master/img/JS1_shop/myAccount2.jpg"
                    alt
                  />
                  <div>
                    <div>Rebox Zane</div>
