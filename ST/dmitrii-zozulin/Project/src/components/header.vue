<template>
  <header class="container px-0 my-4">
    <div class="row col-12 d-flex px-0 mx-0">
      <div
        class="logo d-flex justify-content-center px-0
                col-7
      ...
      >
        <a href="#" class="pr-2"><img src="../assets/imgs/logotype.png" alt="logo"/></a>
      ...
      <div
        class="row headerAccountAndCart d-none  align-items-center
    ...
    <div class="row mx-0 d-md-none pt-3 justify-content-between">
      <div
        class="burgermenu justify-content-between align-items-center
                                col-2 pt-1
                                col-sm-6"
      >
        <div class="dropdown">
      ...
      <div
        class="headerAccountAndCart d-flex align-items-center justify-content-end
                                col-2 pt-1
                                col-sm-6"
      >
        <div class="headerCart pr-4">
